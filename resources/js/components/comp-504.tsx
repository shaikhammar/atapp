    ...
    return (
        <div>
            <Calendar
                ...
                components={{
                    CaptionLabel: (props: CaptionLabelProps) => <CaptionLabel isYearView={isYearView} setIsYearView={setIsYearView} {...props} />,
...
export function CaptionLabel({
    ...
    return (
        ...
        >
            {children}
            <ChevronDownIcon size={16} className="text-muted-foreground/80 shrink-0 transition-transform duration-200" aria-hidden="true" />
        </Button>
    );
}

export function CollapsibleYear({ title, children, open }: { title: string; children: React.ReactNode; open?: boolean }) {
    return (
